...
func (h2 H2Type) metadata(whereFunc func() string) (result []*DatabaseConfigType, err error) {
	tx, err := h2.IDb.Begin()
	if err != nil {
		return
	}
...
func (h2 H2Type) HighestDatabaseConfigVersion(DatabaseConfigId sql.NullInt64) (result sql.NullInt64, err error) {
